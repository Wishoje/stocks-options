...
export default {
  ...
  computed: {
    ...
    focusedData() {
      ...
      // Keep strikes where max(|ΔVol|) >= 2% of max, but at least 500 contracts
      const threshold = Math.max(maxAbs * 0.02, 500)
        ...
        datasets: [
          {
            label: 'Call ΔVol',
            data: callData,
            backgroundColor: 'rgba(52,211,153,0.9)', // green-ish for call volume
            borderRadius: 3,
            barPercentage: 0.9,
          ...
          },
          {
            label: 'Put ΔVol',
            data: putData,
            backgroundColor: 'rgba(248,113,113,0.9)', // red-ish for put volume
            borderRadius: 3,
            barPercentage: 0.9,
            categoryPercentage: 0.9,
          },
