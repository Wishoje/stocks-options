<template>
  ...
  >
    <template #help>
      <div class="gex-stack">
        <p><strong>Contract volume change</strong> compares traded contracts at each strike with the selected comparison date. Positive values show more volume; negative values show less.</p>
